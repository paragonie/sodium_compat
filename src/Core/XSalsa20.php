...
abstract class ParagonIE_Sodium_Core_XSalsa20 extends ParagonIE_Sodium_Core_HSalsa20
{
     ...
     * @throws TypeError
     */
    public static function xsalsa20(int $len, string $nonce, string $key): string
    {
        return self::salsa20(
            $len,
     ...
     * @throws TypeError
     */
    public static function xsalsa20_xor(string $message, string $nonce, string $key): string
    {
