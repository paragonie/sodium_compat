 ...
 */
class ParagonIE_Sodium_Core_Curve25519 extends ParagonIE_Sodium_Core_Curve25519_H
{
    /**
    ...
    public static function fe_sq2(ParagonIE_Sodium_Core_Curve25519_Fe $f)
    {
        ...
        $f1f1_2 = $f1_2 * (int) $f1;
        $f1f2_2 = $f1_2 * (int) $f2;
        $f1f3_4 = $f1_2 * (int) $f3_2;
        $f1f4_2 = $f1_2 * (int) $f4;
        $f1f5_4 = $f1_2 * (int) $f5_2;
        $f1f6_2 = $f1_2 * (int) $f6;
        $f1f7_4 = $f1_2 * (int) $f7_2;
        $f1f8_2 = $f1_2 * (int) $f8;
        $f1f9_76 = $f1_2 * (int) $f9_38;
        $f2f2 = $f2 * (int) $f2;
        $f2f3_2 = $f2_2 * (int) $f3;
        $f2f4_2 = $f2_2 * (int) $f4;
        $f2f5_2 = $f2_2 * (int) $f5;
        $f2f6_2 = $f2_2 * (int) $f6;
        $f2f7_2 = $f2_2 * (int) $f7;
        $f2f8_38 = $f2_2 * (int) $f8_19;
        $f2f9_38 = $f2 * (int) $f9_38;
        $f3f3_2 = $f3_2 * (int) $f3;
        $f3f4_2 = $f3_2 * (int) $f4;
        $f3f5_4 = $f3_2 * (int) $f5_2;
        $f3f6_2 = $f3_2 * (int) $f6;
        $f3f7_76 = $f3_2 * (int) $f7_38;
        $f3f8_38 = $f3_2 * (int) $f8_19;
        $f3f9_76 = $f3_2 * (int) $f9_38;
        $f4f4 = $f4 * (int) $f4;
        $f4f5_2 = $f4_2 * (int) $f5;
        $f4f6_38 = $f4_2 * (int) $f6_19;
        $f4f7_38 = $f4 * (int) $f7_38;
        $f4f8_38 = $f4_2 * (int) $f8_19;
        $f4f9_38 = $f4 * (int) $f9_38;
        $f5f5_38 = $f5 * (int) $f5_38;
        $f5f6_38 = $f5_2 * (int) $f6_19;
        $f5f7_76 = $f5_2 * (int) $f7_38;
        $f5f8_38 = $f5_2 * (int) $f8_19;
        $f5f9_76 = $f5_2 * (int) $f9_38;
        $f6f6_19 = $f6 * (int) $f6_19;
        $f6f7_38 = $f6 * (int) $f7_38;
        $f6f8_38 = $f6_2 * (int) $f8_19;
        $f6f9_38 = $f6 * (int) $f9_38;
        $f7f7_38 = $f7 * (int) $f7_38;
        $f7f8_38 = $f7_2 * (int) $f8_19;
        $f7f9_76 = $f7_2 * (int) $f9_38;
        $f8f8_19 = $f8 * (int) $f8_19;
        $f8f9_38 = $f8 * (int) $f9_38;
        $f9f9_38 = $f9 * (int) $f9_38;
