...
const SODIUM_CRYPTO_PWHASH_SALTBYTES = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_SALTBYTES;
const SODIUM_CRYPTO_PWHASH_STRPREFIX = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_STRPREFIX;
const SODIUM_CRYPTO_PWHASH_MEMLIMIT_INTERACTIVE = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_MEMLIMIT_INTERACTIVE;
const SODIUM_CRYPTO_PWHASH_OPSLIMIT_INTERACTIVE = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_OPSLIMIT_INTERACTIVE;
const SODIUM_CRYPTO_PWHASH_MEMLIMIT_MODERATE = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_MEMLIMIT_MODERATE;
const SODIUM_CRYPTO_PWHASH_OPSLIMIT_MODERATE = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_OPSLIMIT_MODERATE;
const SODIUM_CRYPTO_PWHASH_MEMLIMIT_SENSITIVE = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_MEMLIMIT_SENSITIVE;
const SODIUM_CRYPTO_PWHASH_OPSLIMIT_SENSITIVE = ParagonIE_Sodium_Compat::CRYPTO_PWHASH_OPSLIMIT_SENSITIVE;
